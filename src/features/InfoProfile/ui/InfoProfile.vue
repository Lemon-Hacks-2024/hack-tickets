                        ...
                        <div>
                            <a-flex vertical>
                                <a-form-item label="Фамилия *" vertical>
                                    <a-input v-model:value="formState.firstName" placeholder="Битков *" />
                                </a-form-item>
                                <a-form-item label="Почту *">
                                    <a-input v-model:value="formState.mail" placeholder="Example@mail.com *" />
                                </a-form-item>
                            </a-flex>
                        </div>
                        <div>
                            <a-flex horizontal>
                                <a-form-item label="Имя *">
                                    <a-input v-model:value="formState.lastName" placeholder="Дмитрий" />
                                </a-form-item>
